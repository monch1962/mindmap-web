...
describe('useUndoRedo', () => {
  ...
  it('should jump to history point', () => {
    ...
    const nodes1: Node<MindMapNodeData>[] = [{ id: '1', type: 'mindmap', position: { x: 0, y: 0 }, data: { label: '1' } }];
    const nodes2: Node<MindMapNodeData>[] = [{ id: '2', type: 'mindmap', position: { x: 0, y: 0 }, data: { label: '2' } }];
    const nodes3: Node<MindMapNodeData>[] = [{ id: '3', type: 'mindmap', position: { x: 0, y: 0 }, data: { label: '3' } }];
    ...
    const state = result.current.jumpToHistory(0, true);
